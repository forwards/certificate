...
params:
  ...
  organization_url:
    ...
    input: text
  border_image:
    label: Whether "border.png" exists
    value: FALSE
    input: logical
  papersize:
...
organization: "`r params$organization`"
...
```{r, results = 'asis'}
if (!is.null(params$curriculum_file)) {
  cat(readLines(params$curriculum_file), sep = "\n")
} else cat(params$curriculum, "\n", sep = "\n\n")
```
